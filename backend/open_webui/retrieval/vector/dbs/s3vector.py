...
class S3VectorClient(VectorDBBase):
    """
    AWS S3 Vector integration for Zeytoon GPT Knowledge.
    """
    ...
    def _filter_metadata(self, metadata: Dict[str, Any], item_id: str) -> Dict[str, Any]:
        ...
        # Keep only the first 10 keys, prioritizing important ones based on actual Zeytoon GPT metadata
        important_keys = [
    ...
    def get(self, collection_name: str) -> Optional[GetResult]:
        ...
        try:
            ...
            # The Zeytoon GPT GetResult expects lists of lists, so we wrap each list
            if all_ids:
